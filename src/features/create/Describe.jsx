        ...
        <>
          ...
          >
            ...
            <textarea
              id="description"
              rows="4"
              className="block my-1 sm:my-3 p-1.5 sm:p-2.5 w-full sm:w-full text-xl sm:text-2xl text-left sm:text-center text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-blue-500 dark:focus:border-blue-500"
